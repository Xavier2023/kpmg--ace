      ...
      <div className="dark">
        <div className='request-section'>
          ...
          <form className="form">
            ...
            <label className="add-photo-btn">Browse<span><input type="file" id="myfile" name="myfile" /></span>
            </label>
          </form>
          <form className="form">
            <input type="text" id="path" placeholder='No file selected'/>
          ...
          <form className="form">
          <textarea name="message" id="message" cols="55" rows="5"> Request Message</textarea>
          </form>
